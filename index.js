...
(async()=>{
	const views = await getData('https://api.github.com/repos/nach131/push_swap/traffic/views');
	const clone = await getData('https://api.github.com/repos/nach131/push_swap/traffic/clones');
